...
public class KubbentTor extends ReactContextBaseJavaModule {
  OnionProxyManager onionProxyManager;
  String fileStorageLocation;
  private final String TAG = "KubbentTor";

  public KubbentTor(ReactApplicationContext reactContext) {
    super(reactContext);
    ...
    protected String doInBackground(String... strings) {
      try {
        ...
        onionProxyManager.getTorInstaller().updateTorConfigCustom(
          "RunAsDaemon 1\n" +
          "AvoidDiskWrites 1\n" +
          "ControlPort " + KubbentTorUtils.getControlPort() + "\n" +
          "SOCKSPort " + KubbentTorUtils.getSocksPort() + "\n" +
          "DNSPort 0\n" +
          "TransPort 0\n" +
